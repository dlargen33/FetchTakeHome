...
/// Represents HTTP status codes and their associated errors.
///
/// This enum maps all standard HTTP status codes and conforms to `Error`,
/// allowing it to be used for error handling in network requests.
///
/// - Note: The raw values correspond to standard HTTP response codes (e.g., `200` for OK, `404` for Not Found).
/// 
